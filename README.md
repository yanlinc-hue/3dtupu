...
- OpenAI 可直读完整 PDF 的文字层与高清页面，用跨页上下文还原表格、脚注和主体全称
- PDF 重点页和 PNG/JPEG/WebP 都经过第二次独立视觉复核；跨页延续仅提示，关键股比、金额和方向不确定时才阻断
- 使用大模型完成全文理解、跨文件实体消歧、关系复核与证据完整性校验
- 点击节点、关系或路径即可围绕当前视图继续提问
- 回答同时结合图谱结构与文档原文，并可回到来源证据核验
- 支持 Ollama、OpenAI 官方 Responses PDF 输入及 OpenAI 兼容接口
